...
class ShareRecordsOperations{
	...
	async revokeSharedRecord()	{
		...
		const require = createRequire(import.meta.url);
		let DeleteActionHandler = require.resolve("./delete_action_handler.js");
...
class GetSharedRecordDetailsParam{
	...
	static SHAREDTO = new Param("sharedTo", "com.zoho.crm.api.ShareRecords.GetSharedRecordDetailsParam");
	static VIEW = new Param("view", "com.zoho.crm.api.ShareRecords.GetSharedRecordDetailsParam");
}
