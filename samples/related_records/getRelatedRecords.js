...
await GetRelatedRecords.initialize();
let moduleAPIName = "leads";
let recordId = 440248000000774074n;
let relatedListAPIName = "notes";
await GetRelatedRecords.getRelatedRecords(moduleAPIName,recordId,relatedListAPIName);
export {
    GetRelatedRecords as GetRelatedRecords
}
