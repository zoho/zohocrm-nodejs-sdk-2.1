...
const Constants = require('@zohocrm/nodejs-sdk-2.1/utils/util/constants').Constants;
const SDKException = require('@zohocrm/nodejs-sdk-2.1/core/com/zoho/crm/api/exception/sdk_exception').SDKException;
const { OAuthToken, TokenType } = require("@zohocrm/nodejs-sdk-2.1/models/authenticator/oauth_token");
/**
                    ...
                    connection.query(sqlQuery, function (err, result) {
                        ...
                        if (result.length > 0) {
                            for (let row of result) {
                                ...
                                let token = new OAuthToken(row.client_id, null, tokenValue, tokenType);
