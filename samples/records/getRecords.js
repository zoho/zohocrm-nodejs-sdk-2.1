...
class GetRecords{
    ...
    static async getRecords(moduleAPIName) {
        ...
        await paramInstance.add(ZOHOCRMSDK.Records.GetRecordsParam.CVID, "34770610087501");
        ...
        await paramInstance.add(ZOHOCRMSDK.Records.GetRecordsParam.PER_PAGE, 1);
        ...
        await paramInstance.add(ZOHOCRMSDK.Records.GetRecordsParam.TERRITORY_ID, "34096430505351");
...
await GetRecords.getRecords(moduleAPIName);
export {
