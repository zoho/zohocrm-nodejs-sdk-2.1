...
class AssignTerritoryToRecord{
    ...
    static async assignTerritoryToRecord(moduleAPIName, recordId) {
        ...
        let response = await recordOperations.assignTerritoryToRecord(moduleAPIName, recordId, request);
        if (response != null) {
...
await AssignTerritoryToRecord.initialize();
let moduleAPIName ="Leads";
let recordId = 400012300002111n;
await AssignTerritoryToRecord.assignTerritoryToRecord(moduleAPIName,recordId);
export {
    AssignTerritoryToRecord as AssignTerritoryToRecord
}
