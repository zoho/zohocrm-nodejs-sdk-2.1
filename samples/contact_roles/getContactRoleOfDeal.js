...
class GetContactRoleOfDeal{
    ...
    static async getContactRoleOfDeal(contactId, dealId) {
        ...
        let response = await contactRolesOperations.getContactRoleOfDeal(
            contactId,
            dealId
        );
        if (response !== null) {
...
await GetContactRoleOfDeal.initialize();
let contactId = 300021n;
let dealId = 322111n;
await GetContactRoleOfDeal.getContactRoleOfDeal(contactId,dealId);
export {
    GetContactRoleOfDeal as GetContactRoleOfDeal
}
