...
class Field{
	 ...
	 */
	setPrivate(private1)	{
		const Private = require("../fields/private").MasterModel;
	...
	setRelatedDetails(relatedDetails)	{
		const RelatedDetails = require("../fields/related_details").MasterModel;
	 ...
	 */
	setCrypt(crypt)	{
		const Crypt = require("../fields/crypt").MasterModel;
	...
	setAssociationDetails(associationDetails)	{
		const AssociationDetails = require("../fields/association_details").MasterModel;
	...
	setCurrency(currency)	{
		const Currency = require("../fields/currency").MasterModel;
	 ...
	 */
	setLookup(lookup)	{
		const Module = require("../fields/module").MasterModel;
	...
	setViewType(viewType)	{
		const ViewType = require("../fields/view_type").MasterModel;
	 ...
	 */
	setUnique(unique)	{
		const Unique = require("../fields/unique").MasterModel;
	 ...
	 */
	setFormula(formula)	{
		const Formula = require("../fields/formula").MasterModel;
	...
	setMultiselectlookup(multiselectlookup)	{
		const MultiSelectLookup = require("../fields/multi_select_lookup").MasterModel;
	...
	setMultiuserlookup(multiuserlookup)	{
		const MultiUserLookup = require("../fields/multi_user_lookup").MasterModel;
	...
	setAutoNumber(autoNumber)	{
		const AutoNumber = require("../fields/auto_number").MasterModel;
	...
	setExternal(external)	{
		const External = require("../fields/external").MasterModel;
	...
	setHistoryTracking(historyTracking)	{
		const HistoryTracking = require("../fields/history_tracking").MasterModel;
