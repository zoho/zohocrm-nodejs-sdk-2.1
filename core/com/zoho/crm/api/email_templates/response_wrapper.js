...
class ResponseWrapper{
	 ...
	 * @returns {Array} An Array representing the emailTemplates
	 */
	getEmailTemplates()	{
	 ...
	 * @param {Array} emailTemplates An Array representing the emailTemplates
	 */
	 ...
	 */
	setInfo(info)	{
		const Info = require("../record/info").MasterModel;
